...
//
// Any math functions that do not have an easy to understand/use equivalent in the C/C++
// standard library and are too generic to warrant their own header file should go here.
//
